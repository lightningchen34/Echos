...
public class RSSChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RSSChannelAdapter(Context mContext, List<RSSChannelBean> mList) {
        this.mContext = mContext;
        this.mList = mList;
    }

    public void setOnItemRangeChangeListener(RSSChannelAdapter.onItemRangeChangeListener onItemRangeChangeListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        } else if (viewType == R.layout.adapter_button) {
    ...
    private void setChannel(final ChannelHolder holder, RSSChannelBean bean) {
    ...
    private void setTab(final TabHolder holder) {
        ...
        holder.add.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            @Override
            public boolean onPreDraw() {
                Layout layout = holder.add.getLayout();
                holder.add.getViewTreeObserver().removeOnPreDrawListener(this);
                return true;
            }
        });
        holder.add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mList.add(new RSSChannelBean(holder.title.getText().toString(), holder.url.getText().toString(), 1, R.layout.adapter_channel));
    ...
    private void removeFromSelected(ChannelHolder holder) {
        ...
        holder.delete.setVisibility(View.GONE);
        RSSChannelBean bean = mList.get(position);
    ...
    class TabHolder extends RecyclerView.ViewHolder {
        ...
        public TabHolder(View itemView) {
            super(itemView);
            add = itemView.findViewById(R.id.add_channel);
            title = itemView.findViewById(R.id.rss_title);
            url = itemView.findViewById(R.id.rss_url);
        }
    }
